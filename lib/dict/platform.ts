...
export const platformDict: Record<string, LocalizedText> = {
  ...
  navSectionWorkspace: { en: 'Workspace', ar: 'مساحة العمل' },
  navSectionPeople: { en: 'People & Operations', ar: 'الكوادر والعمليات' },
  navSectionFinance: { en: 'Finance & Compliance', ar: 'المالية والامتثال' },
  searchPlaceholder: { en: 'Search by name, title, or email…', ar: 'ابحث بالاسم، المسمى الوظيفي، أو البريد…' },
  consoleSearchPlaceholder: { en: 'Quick search (⌘K)…', ar: 'بحث سريع (⌘K)…' },
  companyStatusLive: { en: 'Live System', ar: 'النظام نشط' },
  navDashboard: { en: 'Dashboard', ar: 'لوحة القيادة' },
  navPeople: { en: 'People Directory', ar: 'دليل الموظفين' },
  navPayroll: { en: 'Payroll & WPS', ar: 'الرواتب وحماية الأجور' },
  navTimeOff: { en: 'Time Off & Leave', ar: 'الإجازات والدوام' },
  navHiring: { en: 'Hiring Pipeline', ar: 'إدارة التوظيف' },
  navOnboarding: { en: 'Onboarding', ar: 'تهيئة الموظفين' },
  navCompliance: { en: 'Compliance & Nitaqat', ar: 'الامتثال ونطاقات' },
  navBenefits: { en: 'Benefits', ar: 'المزايا' },
  navPerformance: { en: 'Performance', ar: 'الأداء' },
  navReports: { en: 'Reports & Analytics', ar: 'التقارير والمؤشرات' },
